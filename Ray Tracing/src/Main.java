...
//		scene.add(new Sphere(new Vector(0, 0,0.2), 0.2, globe));
		...
		scene.add(new ParallelPiped(new Vector(0.3, 0.3, 0), new Vector(0.3, 0, 0), new Vector(0, 0.5, 0), new Vector(0, 0, 0.1), Material.plastic(Color.WHITE)));
		scene.add(new Cylinder(new Vector(0, 0, 0), new Vector(0, 0, .5), .3, Material.plastic(Color.WHITE)));
