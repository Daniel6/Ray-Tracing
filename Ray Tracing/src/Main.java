...
public class Main {
	public static void main(String args[]) {
		...
		scene.add(new Sphere(new Vector(0,0,0), 0.4, new Material(Color.GRAY, Color.GRAY, Color.BLACK, 1)));
		...
		scene.add(new Plane(new Vector(0,0,-0.2), new Vector(0,0,1), new Material(Color.GRAY, Color.GRAY, Color.BLACK, 1)));
